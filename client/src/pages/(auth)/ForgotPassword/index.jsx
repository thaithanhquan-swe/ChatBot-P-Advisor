  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit} className='space-y-6'>
        <div>
          ...
          <div className='flex h-[54px] items-center gap-3 rounded-[8px] border border-[#dedede] bg-white px-4 transition focus-within:border-[#d71920] focus-within:ring-3 focus-within:ring-[#d71920]/10'>
            ...
            <input
              ...
              required
              className='h-full w-full bg-transparent text-[14px] text-[#222] outline-none placeholder:text-[#a3a3a3]'
            />
          </div>
        </div>
        ...
        <button
          type='submit'
          className='flex h-[54px] w-full cursor-pointer items-center justify-center gap-2 rounded-[8px] bg-[#d71920] text-[15px] font-semibold text-white shadow-[0_8px_18px_rgba(215,25,32,0.16)] transition hover:bg-[#bd1118] active:translate-y-px'
        >
          <Send size={18} />
