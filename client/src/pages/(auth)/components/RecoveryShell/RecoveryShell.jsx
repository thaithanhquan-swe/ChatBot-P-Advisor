...
const RecoveryShell = ({ icon: Icon, title, description, children }) => {
  return (
    <div className='relative min-h-screen overflow-hidden bg-[#fffdfc] px-4 py-8 sm:px-6 lg:px-8'>
      ...
      <div className='relative z-10 mx-auto flex min-h-[calc(100vh-4rem)] w-full max-w-[720px] flex-col items-center justify-center'>
        <div className='w-full rounded-[18px] border border-[#ececec] bg-white px-5 py-8 shadow-[0_12px_35px_rgba(0,0,0,0.06)] sm:px-10 sm:py-10 lg:px-12'>
          <div className='text-center'>
            <div className='mx-auto flex h-[88px] w-[88px] items-center justify-center rounded-full bg-[#fff1f2] text-[#d71920]'>
            ...
            <div className='mx-auto mt-4 h-[3px] w-11 rounded-full bg-[#d71920]' />

            <p className='mx-auto mt-5 max-w-[520px] text-[14px] leading-6 text-[#666] sm:text-[15px]'>
              {description}
            </p>
          </div>
        ...
        <Link
          to='/login'
          className='mt-8 inline-flex items-center gap-2 text-[14px] font-medium text-[#4b5563] transition hover:text-[#d71920]'
        >
          <ArrowLeft size={17} />
          Quay lại đăng nhập
        </Link>
