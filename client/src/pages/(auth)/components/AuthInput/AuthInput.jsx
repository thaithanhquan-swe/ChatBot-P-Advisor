const AuthInput = ({ icon: Icon, rightElement, className = '', ...props }) => {
  return (
    <div className='relative'>
      ...
      <input
        {...props}
        className={`h-12 w-full rounded-xl border border-gray-200 bg-white text-[14px] text-gray-900 placeholder:text-gray-400 outline-none transition focus:border-(--primary-color-border) focus:ring-4 focus:ring-(--primary-color-soft) ${
          Icon ? 'pl-11' : 'pl-4'
